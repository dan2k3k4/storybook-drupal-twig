  ...
  .add(
    ...
    () => `
      <div class="wysiwyg">
        ...
        <pre>This is form formatted text. This is form formatted text that is much longer let's see if it wraps?</pre>
        ...
        <p><abbr>M<sup>lle</sup></abbr> Gwendoline wrote the equation <code>f(x, n) = log<sub>4</sub>x<sup>n</sup></code>. Apparently the line height can go out with <sub>subscript</sub> so I am writing a paragraph here to see what happens. Apparently the line height can go out with subscript so I am writing a paragraph here to see what happens.</p>
